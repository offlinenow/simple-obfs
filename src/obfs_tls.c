...
tls_client_hello_template = {
    ...
    .cipher_suites_len = CT_HTONS(28),
    .cipher_suites = {
        0xda, 0xda, 0xc0, 0x2b, 0xc0, 0x2f, 0xc0, 0x2c, 0xc0, 0x30, 0xcc, 0xa8, 
...
tls_ext_others_template = {
    ...
    .sig_algos_ext_len = CT_HTONS(20),
    .sig_algos_len = CT_HTONS(18),
    .sig_algos = {
        0x04, 0x03, 0x08, 0x04, 0x04, 0x01, 0x05, 0x03, 0x08, 0x05, 0x05, 
